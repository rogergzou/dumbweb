<?php
    ...
    /**
     * Apologizes to user with message when on limits.php page.
     */
    function apologize_limits($message)
    {
        render("apology_limits.php", ["message" => $message]);
        exit;
    }
    
    /**
     * Apologizes to user with message when on expenses.php page.
     */
    function apologize_expenses($message)
    {
        render("apology_expenses.php", ["message" => $message]);
        exit;
    }
    ...
    /**
     * Returns an array of all categories in expenses table
     */
    function categories()
    {
